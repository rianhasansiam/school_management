  ...
  const testimonials = [
    {
      ...
      text: 'ByteEdu has transformed how we manage our school. The efficiency gains are remarkable.',
      avatar: 'R',
    },
    {
      name: 'Sarah Ahmed',
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#testimonials" className="text-gray-600 hover:text-black transition-colors font-medium">Testimonials</a>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-gray-100 rounded-full blur-3xl" />
          <div className="absolute top-1/2 -left-40 w-80 h-80 bg-gray-50 rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-1/3 w-64 h-64 bg-gray-100 rounded-full blur-3xl" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-gray-100 border border-gray-200 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-gray-700">Trusted by 500+ Schools</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/login">
                  <Button 
                    size="lg" 
                    className="bg-black hover:bg-gray-800 text-white shadow-xl text-base px-8 h-14 w-full sm:w-auto"
                  >
                    Start Free Trial
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-gray-300 hover:border-black hover:bg-gray-50 text-gray-700 text-base px-8 h-14 w-full sm:w-auto"
                >
              ...
              <div className="mt-12 flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex -space-x-3">
                  {['R', 'S', 'K', 'A'].map((letter, i) => (
                    <div 
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-white bg-black flex items-center justify-center text-white font-semibold text-sm shadow-lg"
                    >
                      {letter}
                    </div>
                  ))}
            ...
            <div className="relative hidden lg:block">
              {/* Main Card */}
              <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-200 p-6 transform rotate-1 hover:rotate-0 transition-transform duration-500">
                {/* Header */}
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                    <ClipboardCheck className="w-6 h-6 text-black mb-2" />
                ...
                <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs text-black font-medium">+12%</span>
                  </div>
                  <div className="flex items-end gap-2 h-16">
                    {[40, 65, 45, 80, 55, 90, 75].map((height, i) => (
                      <div 
                        key={i} 
                        className="flex-1 bg-black rounded-t-md"
                        style={{ height: `${height}%` }}
                      />
                    ))}
                  </div>
              ...
              {/* Floating Card */}
              <div className="absolute -left-8 bottom-20 bg-white rounded-2xl shadow-xl border border-gray-200 p-4 transform -rotate-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="w-14 h-14 mx-auto mb-4 bg-white border border-gray-200 rounded-2xl flex items-center justify-center group-hover:bg-black group-hover:border-black transition-colors">
                  <stat.icon className="w-7 h-7 text-black group-hover:text-white transition-colors" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 bg-black group-hover:bg-gray-800 transition-colors">
      ...
      <section id="about" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2 mb-4">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                ByteEdu is designed specifically for educational institutions. 
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100">
                      ...
                      <span className="text-black font-bold">-65%</span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100">
                      <span className="text-gray-700">Report Generation</span>
                      <span className="text-black font-bold">10x Faster</span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See what educators are saying about ByteEdu
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-black hover:shadow-lg transition-all">
      ...
      <section className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Join hundreds of schools already using ByteEdu to streamline their operations.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/login">
              <Button 
                size="lg" 
                className="bg-white text-black hover:bg-gray-100 shadow-xl text-base px-8 h-14"
              >
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-4">
              Meet the Team Behind ByteEdu
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Passionate professionals dedicated to transforming education management
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center group">
                <div className="relative w-32 h-32 mx-auto mb-6">
                  <div className="absolute inset-0 bg-black rounded-full blur-lg opacity-20 group-hover:opacity-40 transition-opacity" />
                  <img
                    src={member.image}
                    alt={member.name}
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-8 bg-gray-50 rounded-2xl border border-gray-200 hover:border-black transition-colors group">
              <div className="w-14 h-14 bg-black rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <Phone className="w-6 h-6 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">Phone</h3>
              <p className="text-gray-600">+8801627076527</p>
            </div>
            <div className="text-center p-8 bg-gray-50 rounded-2xl border border-gray-200 hover:border-black transition-colors group">
              <div className="w-14 h-14 bg-black rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray-600">contact@byteblooper.com</p>
            </div>
            <div className="text-center p-8 bg-gray-50 rounded-2xl border border-gray-200 hover:border-black transition-colors group">
              <div className="w-14 h-14 bg-black rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
      ...
      <footer className="bg-black text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold">ByteEdu</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2026 ByteEdu. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
