...
export default function AssignmentsPage() {
  ...
  const availableAssignments = isAdmin 
    ? DEMO_ASSIGNMENTS 
    : DEMO_ASSIGNMENTS.filter(a => a.teacherId === myTeacherProfile?.id);
  ...
  }, [searchTerm, classFilter, subjectFilter, statusFilter, availableAssignments]);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-orange-800">
                  {DEMO_ASSIGNMENTS.filter((a) => a.status === AssignmentStatus.PUBLISHED).length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {DEMO_ASSIGNMENTS.filter((a) => a.status === AssignmentStatus.DRAFT).length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-800">
                  {DEMO_ASSIGNMENTS.filter((a) => a.status === AssignmentStatus.CLOSED).length}
                </p>
              </div>
            </div>
          </CardContent>
