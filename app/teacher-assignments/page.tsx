...
import { Teacher, Class, Subject, Assignment } from '@/lib/types';
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-800">
                  {DEMO_CLASSES.filter((c: Class) => c.classTeacherId).length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-800">
                  {DEMO_SUBJECTS.filter((s: Subject) => s.teacherId).length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-orange-800">
                  {DEMO_ASSIGNMENTS.filter((a: Assignment) => a.teacherId).length}
                </p>
              </div>
            </div>
          </CardContent>
...
function TeacherOverview() {
  ...
  const filteredTeachers = React.useMemo(() => {
    return DEMO_TEACHERS.filter((teacher: Teacher) => {
  ...
  const getTeacherStats = (teacherId: string) => {
    const classCount = DEMO_CLASSES.filter((c: Class) => c.classTeacherId === teacherId).length;
    const subjectCount = DEMO_SUBJECTS.filter((s: Subject) => s.teacherId === teacherId).length;
    const taskCount = DEMO_ASSIGNMENTS.filter((a: Assignment) => a.teacherId === teacherId).length;
    return { classCount, subjectCount, taskCount };
  };

  const selectedTeacherData = selectedTeacher 
    ? DEMO_TEACHERS.find((t: Teacher) => t.id === selectedTeacher) 
    : null;
