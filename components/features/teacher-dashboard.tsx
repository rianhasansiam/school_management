...
export function TeacherDashboard() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <Card className="bg-linear-to-r from-gray-800 to-black text-white">
        <CardContent className="p-4 md:p-6">
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 items-start sm:items-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2 md:gap-4 mt-3 md:mt-4 text-xs md:text-sm text-gray-300">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
        <StatCard
          ...
          icon={<BookOpen className="w-5 h-5 md:w-6 md:h-6 text-gray-600" />}
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          statuses[index] === 'ongoing' && 'bg-gray-100 border-gray-300',
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="p-3 bg-gray-100 rounded-lg text-center">
                    ...
                    <p className="text-2xl font-bold text-gray-700 mt-1">{attendanceStats.total}</p>
